namespace taskManager
{
    partial class Task_Groub_box
    {
        ...
        private void InitializeComponent()
        {
            ...
            Edit_btn = new Button();
            End_txtbox = new TextBox();
            To_lbl = new Label();
            Start_txtbox = new TextBox();
            From_lbl = new Label();
            Task_ID_txtbox = new TextBox();
            ...
            Task_gbx.Controls.Add(End_txtbox);
            Task_gbx.Controls.Add(To_lbl);
            Task_gbx.Controls.Add(Start_txtbox);
            Task_gbx.Controls.Add(From_lbl);
            Task_gbx.Controls.Add(Task_ID_txtbox);
            Task_gbx.Controls.Add(Task_ID_lbl);
            Task_gbx.Controls.Add(Task_title_txtbox);
            Task_gbx.Controls.Add(Task_Name_lbl);
            Task_gbx.Location = new Point(14, 19);
            Task_gbx.Name = "Task_gbx";
            Task_gbx.Size = new Size(388, 261);
            Task_gbx.TabIndex = 0;
